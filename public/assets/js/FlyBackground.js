  ...
  $.fn.Background = function (options) {
    ...
    function createBird(birdId) {
      ...
      wingEndX =
        startX +
        (endX - startX) / 1.5 -
        (endX - startX) * Math.abs(bird[birdId].wingStretch - 1) * 0.1;
      wingEndX2 =
        startX +
        (endX - startX) / 1.4 +
        (endX - startX) * Math.abs(bird[birdId].wingStretch - 1) * 0.05;
      ...
      ctx.bezierCurveTo(
        ...
        startY + (endX - startX) / 4,
        startX + (endX - startX) / 2,
        startY - (endX - startX) / 3,
        endX,
        endY
      );
      ...
      ctx.bezierCurveTo(
        endX - (endX - startX) / 3,
        endY,
        endX - (endX - startX) / 2.4,
        startY + (endX - startX) / 3,
        startX + (endX - startX) / 5,
        startY + (endX - startX) / 7
      );
      ...
      ctx.bezierCurveTo(
        wingStartX - (wingEndX - wingStartX),
        wingStartY - (wingStartY - wingEndY) / 2,
        wingStartX + (wingEndX - wingStartX),
        wingStartY - (wingStartY - wingEndY) / 1.5,
        wingStartX + (wingEndX - wingStartX) / 2,
        wingEndY
      );

      ctx.bezierCurveTo(
        wingStartX + (wingEndX - wingStartX) * 1.5,
        wingStartY - (wingStartY - wingEndY) / 2,
        wingStartX + (wingEndX - wingStartX),
        wingStartY - (wingStartY - wingEndY) / 1.5,
        wingEndX,
      ...
      ctx.bezierCurveTo(
        wingStartX2 - (wingEndX2 - wingStartX2),
        wingStartY2 - (wingStartY2 - wingEndY2) / 2,
        wingStartX2 + (wingEndX2 - wingStartX2),
        wingStartY2 - (wingStartY2 - wingEndY2) / 1.5,
        wingStartX2 + (wingEndX2 - wingStartX2) / 2,
        wingEndY2
      );

      ctx.bezierCurveTo(
        wingStartX2 + (wingEndX2 - wingStartX2) * 1.5,
        wingStartY2 - (wingStartY2 - wingEndY2) / 2,
        wingStartX2 + (wingEndX2 - wingStartX2),
        wingStartY2 - (wingStartY2 - wingEndY2) / 1.5,
        wingEndX2,
